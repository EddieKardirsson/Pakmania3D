...
//////////////////////////////////////////////////////////////////////////
// APakmania3DCharacter

APakmania3DCharacter::APakmania3DCharacter()
{
...
void APakmania3DCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &APakmania3DCharacter::TurnAtRate);
...
void APakmania3DCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void APakmania3DCharacter::MoveForward(float Value)
{
...
void APakmania3DCharacter::MoveRight(float Value)
{
	if ( (Controller != nullptr) && (Value != 0.0f) )
	{
